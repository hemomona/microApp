...
The file showcase.kv.kv describes the main container, while each demonstration
...
copy/paste this directory into /sdcard/kivy/showcase.kv on your Android device.
